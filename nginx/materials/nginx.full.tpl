...
http {
	...
	include {{.ConfigPath}}/default_host/*.conf;
	include {{.ConfigPath}}/proxy_host/*.conf;
	include {{.ConfigPath}}/redirection_host/*.conf;
	include {{.ConfigPath}}/dead_host/*.conf;
	include {{.ConfigPath}}/temp/*.conf;
